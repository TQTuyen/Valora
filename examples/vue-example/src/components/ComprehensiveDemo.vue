<template>
  <div class="comprehensive-demo">
    ...
    <section class="form-section">
      <h2>Contact Us</h2>
      <p class="section-description">Demonstrating character counter using field subscriptions</p>
      ...
      <form @submit.prevent="handleContactSubmit" class="demo-form">
        ...
        <div class="form-group">
          ...
          <textarea
            ...
            :class="{
              ...
              success: contactMessage.isValid.value && contactMessage.touched.value,
            }"
          ></textarea>
        ...
        <!-- Form Actions -->
        <div class="form-actions">
          <button type="submit" class="btn-submit" :disabled="!canSubmitContactForm">
            Send Message
          </button>
          <button type="button" class="btn-secondary" @click="resetContactForm">Clear</button>
        </div>
      </form>
    </section>
