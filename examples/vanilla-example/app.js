...
const registrationAdapter = createVanillaAdapter({
  name: v.string().minLength(2, { message: 'Name must be at least 2 characters' }),
  email: v.string().email({ message: 'Please enter a valid email address' }),
  password: v
    .string()
  ...
  terms: v.boolean().isTrue({ message: 'You must agree to the terms and conditions' }),
});
...
const contactAdapter = createVanillaAdapter({
  name: v.string().minLength(2, { message: 'Name is required (min 2 characters)' }),
  email: v.string().email({ message: 'Valid email address is required' }),
  subject: v.string().minLength(5, { message: 'Subject must be at least 5 characters' }),
  message: v
    .string()
